...
<c:if test="${faqList ne null }">
	...
	<ul class="faqBody">
		<li class="article" id="a1">
			<p class="q"><a href="#a1"><c:out value="${article.titleFaq}" /></a></p>
			<p class="a"><c:out value="${article.contentFaq}" /></p>
		</li>
	</ul>
...
<button type="button" onclick="$('link').attr('href','boardFaq.html?pageNo=1')">CSS(O)</button>
