...
<body>
	...
	<div align="center" class="body">
		...
		<form name="form" method="post"
			action="boardReviewsUpdateForm.html?pageNo=${pageNo}">
			<table>
				<tr height="40px">
					<td>제 목</td>
					<td><input type="text" name="titleRev" size="115"
						value="${boardRev.titleRev}"></td>
				</tr>
				<tr height="40px">
					<td>내 용</td>
					<td><textarea id="content" name="contentRev"
							style="width: 100%; height: 50%; resize: none;">${boardRev.contentRev}</textarea></td>
				</tr>
			</table>
